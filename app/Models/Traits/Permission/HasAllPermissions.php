...
trait HasAllPermissions
{
	...
	use HasSuperAdminPermissions, HasRecruiterPermissions, HasJobseekerPermissions;
	...
	public static function getDefaultPermissions(): array
	{
		return array_merge(
			...
			Permission::getRecruiterPermissions(),
			Permission::getJobseekerPermissions()
		);
	}
	...
	public static function checkDefaultPermissions(): bool
	{
		if (
			...
			|| !Permission::checkRecruiterRoleAndPermissions()
			|| !Permission::checkJobseekerRoleAndPermissions()
		) {
			return false;
		}
	...
	public static function resetDefaultPermissions(): void
	{
		try {
			...
			foreach ($roles as $role) {
				...
				if ($role->name == Role::getRecruiterRole()) {
				...
				if ($role->name == Role::getJobseekerRole()) {
