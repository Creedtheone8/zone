	...
	public function resetAll($action): RedirectResponse
	{
		...
		if ($action == 'reorder') {
			$data = [
				...
				'premium_listings' => ['lft' => 2, 'rgt' => 3, 'active' => 1],
				'latest_listings'  => ['lft' => 4, 'rgt' => 5, 'active' => 1],
				'categories'       => ['lft' => 6, 'rgt' => 7, 'active' => 1],
				'locations'        => ['lft' => 8, 'rgt' => 9, 'active' => 1],
				'companies'        => ['lft' => 10, 'rgt' => 11, 'active' => 1],
				'stats'            => ['lft' => 12, 'rgt' => 13, 'active' => 1],
				'text_area'        => ['lft' => 14, 'rgt' => 15, 'active' => 0],
				'top_ad'           => ['lft' => 16, 'rgt' => 17, 'active' => 0],
				'bottom_ad'        => ['lft' => 18, 'rgt' => 19, 'active' => 0],
			];
