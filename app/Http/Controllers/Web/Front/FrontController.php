...
class FrontController extends Controller
{
	...
	private function getUserMenu(): Collection
	{
		...
		if (doesUserHaveRecruiterPermission($authUser) || doesUserHaveJobseekerPermission($authUser)) {
			// recruiter
			if (doesUserHaveRecruiterPermission($authUser)) {
				$menuArray = [
					[
						'name'       => $isMultipleCompaniesPerUserEnabled ? trans('global.my_companies') : trans('global.my_company'),
					...
					[
						'name'       => trans('global.archived_ads'),
			...
			// jobseeker
			if (doesUserHaveJobseekerPermission($authUser)) {
				$menuArray = [
					[
						'name'       => trans('global.my_resumes'),
					...
					[
						'name'       => trans('global.Favourite jobs'),
