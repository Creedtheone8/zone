...
class ResumeController extends AccountBaseController
{
	...
	public function index()
	{
		...
		$title = trans('global.my_resumes_list') . ' - ' . $appName;
		
		// Meta Tags
		MetaTag::set('title', $title);
		MetaTag::set('description', trans('global.my_resumes_list_on', ['appName' => config('settings.app.name')]));
		
		// Breadcrumb
		BreadcrumbFacade::add(trans('global.my_resumes'));
	...
	{
		// Meta Tags
		MetaTag::set('title', trans('global.Create a resume'));
		MetaTag::set('description', trans('global.Create a resume on', ['appName' => config('settings.app.name')]));
	...
	public function edit($id)
	{
		...
		abort_if(empty($resume), 404, $message ?? trans('global.resume_not_found'));
		
		// Meta Tags
		MetaTag::set('title', trans('global.Edit the resume'));
		MetaTag::set('description', trans('global.Edit the resume on', ['appName' => config('settings.app.name')]));
