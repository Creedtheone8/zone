...
class CompanyController extends AccountBaseController
{
	...
	public function index()
	{
		...
		$title = trans('global.my_companies_list') . ' - ' . $appName;
		
		// Meta Tags
		MetaTag::set('title', $title);
		MetaTag::set('description', trans('global.my_companies_list_on', ['appName' => config('settings.app.name')]));
		
		// Breadcrumb
		BreadcrumbFacade::add(trans('global.my_companies'));
	...
	public function create()
	{
		...
		// Meta Tags
		MetaTag::set('title', trans('global.Create a new company'));
		MetaTag::set('description', trans('global.Create a new company on', ['appName' => config('settings.app.name')]));
	...
	public function edit($id)
	{
		...
		abort_if(empty($company), 404, $message ?? trans('global.company_not_found'));
		
		// Meta Tags
		MetaTag::set('title', trans('global.Edit the Company'));
		MetaTag::set('description', trans('global.Edit the Company on', ['appName' => config('settings.app.name')]));
