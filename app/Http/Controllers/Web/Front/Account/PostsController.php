...
class PostsController extends AccountBaseController
{
	...
	public function onlinePosts()
	{
		...
		MetaTag::set('description', trans('global.my_ads_on', ['appName' => config('settings.app.name')]));
	...
	public function archivedPosts()
	{
		...
		// Meta Tags
		MetaTag::set('title', trans('global.my_archived_ads'));
		MetaTag::set('description', trans('global.my_archived_ads_on', ['appName' => config('settings.app.name')]));
	...
	public function pendingApprovalPosts()
	{
		...
		// Meta Tags
		MetaTag::set('title', trans('global.my_pending_approval_ads'));
		MetaTag::set('description', trans('global.my_pending_approval_ads_on', ['appName' => config('settings.app.name')]));
