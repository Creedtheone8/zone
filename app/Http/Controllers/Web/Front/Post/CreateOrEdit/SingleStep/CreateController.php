...
class CreateController extends BaseController
{
	...
	public function commonQueries(): void
	{
		...
		if (auth()->check()) {
			...
			if ($companies->has(0)) {
				$this->data['selectedCompany'] = $companies->get(0);
				view()->share('selectedCompany', $this->data['selectedCompany']);
			}
		}
	}
	...
	public function showForm(): View|RedirectResponse
	{
		...
		// Only Admin users and Recruiters/Companies can post ads
		if (auth()->check()) {
			$authUser = auth()->user();
