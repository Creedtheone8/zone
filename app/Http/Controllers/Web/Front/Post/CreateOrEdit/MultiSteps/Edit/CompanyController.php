...
class CompanyController extends BaseController
{
	 ...
	 */
	public function showForm($id, Request $request): View|RedirectResponse
	{
		$data = [];
		...
		// Meta Tags
		MetaTag::set('title', trans('global.update_my_ad'));
		MetaTag::set('description', trans('global.update_my_ad'));
		...
		$nextStepUrl = null;
		$nextStepLabel = trans('global.Update');
