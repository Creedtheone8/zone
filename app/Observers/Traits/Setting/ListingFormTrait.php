...
trait ListingFormTrait
{
	...
	{
		$this->multiCompaniesPerUserConfiguration($setting, $original);
	 ...
	 * @return void
	 */
	private function multiCompaniesPerUserConfiguration($setting, $original): void
	{
		$multiCompaniesPerUser = $setting->field_values['multi_companies_per_user'] ?? null;
		$multiCompaniesPerUserOld = $original['field_values']['multi_companies_per_user'] ?? null;
		
		if ($multiCompaniesPerUser != $multiCompaniesPerUserOld) {
