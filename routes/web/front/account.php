	...
	->group(function ($router) {
		...
		Route::prefix('companies')
			...
			->group(function ($router) {
				...
				Route::get('/', 'index')->name('account.companies');
				Route::get('create', 'create')->name('account.companies.create');
				Route::post('/', 'store')->name('account.companies.store');
				Route::get('{id}', 'show')->name('account.companies.show');
				Route::get('{id}/edit', 'edit')->name('account.companies.edit');
				Route::put('{id}', 'update')->name('account.companies.update');
				Route::get('{id}/delete', 'destroy')->name('account.companies.delete');
				Route::post('delete', 'destroy')->name('account.companies.delete.bulk');
			});
		...
		Route::prefix('resumes')
			...
			->group(function ($router) {
				...
				Route::get('/', 'index')->name('account.resumes');
				Route::get('create', 'create')->name('account.resumes.create');
				Route::post('/', 'store')->name('account.resumes.store');
				Route::get('{id}', 'show')->name('account.resumes.show');
				Route::get('{id}/edit', 'edit')->name('account.resumes.edit');
				Route::put('{id}', 'update')->name('account.resumes.update');
				Route::get('{id}/delete', 'destroy')->name('account.resumes.delete');
				Route::post('delete', 'destroy')->name('account.resumes.delete.bulk');
			});
