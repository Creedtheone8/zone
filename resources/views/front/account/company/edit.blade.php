				...
				<div class="col-md-9">
					...
					<div class="container border rounded bg-body-tertiary p-4 p-lg-3 p-md-2">
						<h3 class="fw-bold border-bottom pb-3 mb-4">
							<i class="bi bi-briefcase"></i> {{ trans('global.Edit the Company') }}
						</h3>
						
						@if (isMultipleCompaniesPerUserEnabled())
							<div class="mb-3 pe-3 float-end">
								<a href="{{ url(urlGen()->getAccountBasePath() . '/companies') }}" class="{{ linkClass() }}">
									<i class="bi bi-arrow-90deg-left"></i> {{ trans('global.my_companies') }}
								</a>
							</div>
								...
								<div class="card-body">
									...
									<div class="row d-flex justify-content-center">
										<div class="col-md-10 col-sm-12">
											<form name="company"
											      action="{{ url(urlGen()->getAccountBasePath() . '/companies/' . $companyId) }}"
											      method="POST"
