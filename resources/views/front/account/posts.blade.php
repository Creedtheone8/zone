...
@php
	...
	$pageData = [
		...
		'archived' => [
			...
			'title' => trans('global.archived_ads'),
		...
		'saved-posts' => [
			...
			'title' => trans('global.Favourite jobs'),
								...
								>
									<thead>
										<tr>
											...
											<th scope="col" data-type="numeric" class="d-md-table-cell d-sm-none d-none">{{ trans('global.Salary') }}</th>
