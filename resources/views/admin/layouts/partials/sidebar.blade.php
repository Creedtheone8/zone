		...
		if (!empty($addons)) {
			foreach($addons as $addon) {
				if (method_exists($addon->class, 'getAdminMenu')) {
					$addonsMenu .= call_user_func($plugin->class . '::getAdminMenu');
				}
			}
		}
	@endphp
			...
			<nav class="sidebar-nav">
				<ul id="sidebarnav">
					...
					@if (
						...
						|| doesUserHavePermission($authUser, 'admin.company.view')
						|| doesUserHavePermission($authUser, 'admin.post-type.view')
						|| doesUserHavePermission($authUser, 'admin.salary-type.view')
						...
						<li class="sidebar-item">
							...
							<ul class="collapse first-level" id="collapseListings">
								...
								@endif
								@if (doesUserHavePermission($authUser, 'admin.company.view') || userHasSuperAdminPermissions())
									<li class="sidebar-item">
								...
								@endif
								@if (doesUserHavePermission($authUser, 'admin.post-type.view') || userHasSuperAdminPermissions())
									<li class="sidebar-item">
								...
								@endif
								@if (doesUserHavePermission($authUser, 'admin.salary-type.view') || userHasSuperAdminPermissions())
									<li class="sidebar-item">
					...
					@if (doesUserHavePermission($authUser, 'admin.payment.view') || userHasSuperAdminPermissions())
						<li class="sidebar-item">
