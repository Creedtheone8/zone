...
try {
	...
	File::deleteDirectory(resource_path('views/front/search/company/inc/')); // JC
	...
	File::deleteDirectory(public_path('assets/css/pink/'));
	...
	File::delete(public_path('assets/css/AjaxLoader.gif'));
	File::delete(public_path('assets/css/colo.css'));
	File::delete(public_path('assets/css/grabbing.png'));
	File::delete(public_path('assets/css/longshadow-base-orange.css'));
	File::delete(public_path('assets/css/longshadow.css'));
